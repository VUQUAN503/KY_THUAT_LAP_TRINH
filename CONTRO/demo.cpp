...
void Bai_1(char *str)
{
    std::cout << "Nhap vao doan van nho hon 255 ky tu: ";
    gets(str);
    std::cout << str;
    int dem = 0;
    int dem_2 = 0;
    ...
    std::cout << "so ky tu so trong van ban la: " << dem << std::endl;
    std::cout << "so ky tu khong phai ky tu la tinh trong van ban la: " << dem << std::endl;
}
